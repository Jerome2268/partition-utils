...
class Ui(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.left_close.clicked.connect(self.click_exit)
        self.left_visit = QtWidgets.QPushButton("")  # 空白按钮
        self.left_visit.clicked.connect(self.read_file_path)
        ...
        self.left_button_1 = QtWidgets.QPushButton(qtawesome.icon('fa.sellsy', color='red'), "华语流行")
        self.left_button_1.setObjectName('left_button')
        self.left_button_1.clicked.connect(self.click)
        ...
        self.left_layout.addWidget(self.left_button_1, 2, 0, 1, 3.5)
        ...
        self.right_bar_widget_search_input.setPlaceholderText("输入id， 参与分组")
        ...
        self.newsong_button_1 = QtWidgets.QPushButton("木棉      木棉      永远的木棉      03::29")
        self.newsong_button_2 = QtWidgets.QPushButton("木棉      陈慧娴      永远的木棉      03::29")
        self.newsong_button_3 = QtWidgets.QPushButton("木棉      陈慧娴      永远的木棉      03::29")
        self.newsong_button_4 = QtWidgets.QPushButton("木棉      陈慧娴      永远的木棉      03::29")
        self.newsong_button_5 = QtWidgets.QPushButton("木棉      陈慧娴      永远的木棉      03::29")
        self.newsong_button_6 = QtWidgets.QPushButton("木棉      陈慧娴      永远的木棉      03::29")
        ...
        # self.playlist_button_1.clicked().con
